...
var Notify = (
  ...
  function() {
    function Notify2(args) {
      ...
      var status = args.status, _a = args.type, type = _a === void 0 ? 1 : _a, title = args.title, text = args.text, _b = args.showIcon, showIcon = _b === void 0 ? true : _b, _c = args.customIcon, customIcon = _c === void 0 ? "" : _c, _d = args.customClass, customClass = _d === void 0 ? "" : _d, _e = args.speed, speed = _e === void 0 ? 500 : _e, _f = args.effect, effect = _f === void 0 ? "fade" : _f, _g = args.showCloseButton, showCloseButton = _g === void 0 ? true : _g, _h = args.autoclose, autoclose = _h === void 0 ? false : _h, _j = args.autotimeout, autotimeout = _j === void 0 ? 3e3 : _j, _k = args.gap, gap = _k === void 0 ? 20 : _k, _l = args.distance, distance = _l === void 0 ? 20 : _l, _m = args.position, position = _m === void 0 ? "right top" : _m, _o = args.customWrapper, customWrapper = _o === void 0 ? "" : _o;
    ...
    Notify2.prototype.checkRequirements = function() {
      return !!(this.title || this.text);
    };
    Notify2.prototype.setContainer = function() {
    ...
    Notify2.prototype.setPosition = function() {
    ...
    Notify2.prototype.setCloseButton = function() {
      var _this = this;
    ...
    Notify2.prototype.setWrapper = function() {
    ...
    Notify2.prototype.setContent = function() {
    ...
    Notify2.prototype.setIcon = function() {
    ...
    Notify2.prototype.setObserver = function() {
      var _this = this;
    ...
    Notify2.prototype.notifyIn = function(callback) {
      callback(this);
    };
    Notify2.prototype.autoClose = function() {
      var _this = this;
      setTimeout(function() {
        _this.close();
      }, this.autotimeout + this.speed);
    };
    Notify2.prototype.close = function() {
      this.notifyOut(this.selectedNotifyOutEffect);
    };
    Notify2.prototype.setEffect = function() {
      switch (this.effect) {
        case "fade":
